...
upload_data:
	echo 'XX' | python google_appengine/appcfg.py upload_data --url http://localhost:9000/remote_api --file=~/mindwell_backup_2015_10_03.bin --application=dev~mindwellonline -e test@example.com
